...
entType = "test_suite_link_to_test"
entId = "2023"
entFields = Array("id", "subtype")
entFieldsAttach = Array("id", "name")

Dim link
Set link = entityService.GetById(context, entType, entId, entFields)
MyMsgBox.Show "ID: " + link.Id + ", Test Type: " + link.Subtype, entType + ": " + entId
...
'Set outFile = FSO.CreateTextFile("C:\Downloads\test_suite (manual, hardcoded).txt",True)
